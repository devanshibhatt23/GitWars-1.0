...
def update(context):
    ...
    if game_mode == 1: # Collect the coins
        ...
        for bullet in bullets:
            u,v = find_nearest(my_x, my_y, coins)
            if will_bullet_hit_me(my_x, my_y, bullet):

                # WRITE YOUR LOGIC HERE

                return ("MOVE",(u["x"]-my_x,u["y"]-my_y))
            
            else : return ("MOVE",(u["x"]-my_x,u["y"]-my_y))
        ...
        if coins:
            ...
            if nearest_coin:
                return ("MOVE",(nearest_coin["x"]-my_x,nearest_coin["y"]-my_y))

            # else : return ("MOVE",(nearest_coin["x"],nearest_coin["y"]))
